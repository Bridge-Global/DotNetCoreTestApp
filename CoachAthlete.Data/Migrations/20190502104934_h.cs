...
namespace CoachAthlete.Data.Migrations
{
    public partial class h : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestHeader", x => x.TestHeaderId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SlNo = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AthleteId = table.Column<string>(nullable: true),
                    DistanceOrTime = table.Column<float>(nullable: false),
                    TestHeaderId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestDetail", x => x.SlNo);
                    table.ForeignKey(
                        name: "FK_TestDetail_AspNetUsers_AthleteId",
